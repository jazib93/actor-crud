...
<head>
    ...
    <title>Actor Information Submission</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-center">Actor Information Submission</h2>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('actors.store') }}" method="POST">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary btn-lg">Submit Actor Information</button>
                            </div>
                        </form>
                    </div>
                </div>
